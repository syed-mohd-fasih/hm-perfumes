				...
				<div className="max-w-4xl mx-auto space-y-16">
					...
					<div className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-3xl shadow-lg p-8 md:p-12">
						...
						<p className="text-lg text-foreground/70 leading-relaxed mb-4">
							HM Perfumes was founded with a simple vision: to create exceptional fragrances that capture
							the essence of luxury and elegance. Our journey began in a small atelier where master
							perfumers crafted each scent with meticulous attention to detail.
						</p>
						<p className="text-lg text-foreground/70 leading-relaxed">
							Today, we continue that tradition, blending timeless craftsmanship with modern innovation to
							create perfumes that tell a story and evoke emotion.
						</p>
					</div>
					...
					<div className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-3xl shadow-lg p-8 md:p-12">
						...
						<p className="text-lg text-foreground/70 leading-relaxed mb-4">
							We believe that fragrance is more than just a scent—it's an experience, a memory, a moment
							in time. Our mission is to create perfumes that resonate with your personality and enhance
							your everyday moments.
						</p>
						<p className="text-lg text-foreground/70 leading-relaxed">
							Every bottle is crafted with premium ingredients sourced from around the world, ensuring
							that each fragrance is a masterpiece of quality and sophistication.
						</p>
					</div>
