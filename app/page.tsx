      ...
      <section className="flex-1 flex items-center justify-center px-4 py-20">
        <div className="max-w-4xl w-full text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
            ...
            <Link
              href="/about"
              className="bg-white/5 dark:bg-black/5 backdrop-blur-lg border border-white/10 dark:border-white/5 rounded-3xl shadow-lg px-8 py-4 font-semibold text-foreground hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 ease-out border-2 border-primary/30"
            >
              Learn More
            </Link>
          </div>
          ...
          <div className="pt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              >
                <div className="w-full h-48 bg-gradient-to-br from-primary/20 to-accent/20 rounded-2xl mb-4 flex items-center justify-center">
