        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <ul className="space-y-2 text-sm text-foreground/60">
              ...
              <li>
                <Link href="/products" className="hover:text-foreground transition-all duration-300 ease-out">
                  Products
                </Link>
              </li>
              <li>
                <Link href="/about" className="hover:text-foreground transition-all duration-300 ease-out">
                  About
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-foreground/60">
              <li>
                <Link href="/contact" className="hover:text-foreground transition-all duration-300 ease-out">
                  Contact
                </Link>
              </li>
              <li>
                <a href="#" className="hover:text-foreground transition-all duration-300 ease-out">
                  FAQ
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-foreground/60">
              <li>
                <Link href="/admin/login" className="hover:text-foreground transition-all duration-300 ease-out">
                  Login
                </Link>
              </li>
            </ul>
